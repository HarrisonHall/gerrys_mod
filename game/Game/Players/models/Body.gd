...
var models = {
	"seagul": preload("res://Game/Players/models/seagal/v2/seagullv2.tscn"),
	"seagal": preload("res://Game/Players/models/seagal/v2/seagullv2.tscn"),
	"bokatan": preload("res://Game/Players/models/bokatan/v2/bokatan.tscn"),
	"gdchan": preload("res://Game/Players/models/gdchan/v3/gdchan.tscn"),
	"orango": preload("res://Game/Players/models/Orango/Orango.tscn"),
	"gibby": preload("res://Game/Players/models/Gibby/gibby.tscn"),
	"bobby": preload("res://Game/Players/models/Bobby/bobby.tscn"),
	"bboy": preload("res://Game/Players/models/BannaBoy/bboy1.tscn"),
	"bobo": preload("res://Game/Players/models/Bobo/bobo.tscn"),
	"bobof": preload("res://Game/Players/models/BoboF/bobof.tscn"),
	"garry": preload("res://Game/Players/models/Garry/garry.tscn"),
}
