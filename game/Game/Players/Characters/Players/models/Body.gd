...
var models = {
	"seagul": preload("res://Game/Players/Characters/Players/models/seagal/v2/seagullv2.tscn"),
	"seagal": preload("res://Game/Players/Characters/Players/models/seagal/v2/seagullv2.tscn"),
	"bokatan": preload("res://Game/Players/Characters/Players/models/bokatan/v2/bokatan.tscn"),
	"gdchan": preload("res://Game/Players/Characters/Players/models/gdchan/v3/gdchan.tscn"),
	"orango": preload("res://Game/Players/Characters/Players/models/Orango/Orango.tscn"),
	"gibby": preload("res://Game/Players/Characters/Players/models/Gibby/gibby.tscn"),
	"bobby": preload("res://Game/Players/Characters/Players/models/Bobby/bobby.tscn"),
	"bboy": preload("res://Game/Players/Characters/Players/models/BannaBoy/bboy1.tscn"),
	"bobo": preload("res://Game/Players/Characters/Players/models/Bobo/bobo.tscn"),
	"bobof": preload("res://Game/Players/Characters/Players/models/BoboF/bobof.tscn"),
	"garry": preload("res://Game/Players/Characters/Players/models/Garry/garry.tscn"),
}
...
func hold_object(gun):
	...
	held_object = Resources.object_types[gun.gun_obj].instance()
